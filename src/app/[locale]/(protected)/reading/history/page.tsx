...
import { useGetReadingHistoryQuery } from '@/store/features/reading/readingApi'
...
export default function ReadingHistoryPage() {
  ...
  const {
    ...
    isFetching,
    isError,
  } = useGetReadingHistoryQuery({ page: 1, limit: 50 })
    ...
    <section className="space-y-6">
      <article className="rounded-xl border border-neutral-200 bg-white p-6">
        ...
        <p className="mt-2 max-w-2xl text-sm text-slate-600">
          Browse previous sessions, including completed and in-progress titles.
        </p>
      </article>
      ...
      <article className="space-y-4 rounded-xl border border-neutral-200 bg-white p-6">
        ...
        {isLoading ? (
          <p className="text-sm text-slate-500">Loading reading history...</p>
        ) : null}

...
const AuthShell = ({
  ...
  return (
    <section className="fixed left-0 top-0 hidden lg:block h-dvh w-1/2 overflow-hidden bg-slate-950">
      ...
      <div className="absolute inset-x-0 top-0 h-44 bg-linear-to-b from-black/92 to-transparent" />

      <div className="relative z-10 flex h-dvh flex-col justify-between px-10 py-8 text-white">
        <Logo />
        ...
        <div className="flex items-center">
          <div className="max-w-124">
            ...
            <p className="mt-7 max-w-md text-pretty text-[1.12rem] leading-8 text-white/90 xl:text-[1.2rem] xl:leading-9">
              {description}
            </p>
          </div>
        </div>
